...
class app():
    ...
    def calcula(self):
        ...
        capital, selicpct, cdipct, cdimen, cdidia, txy, txm, alIR, taxacdi, rentpct, impostcdi, impostrent, mes, montanteapl, montpoupanca, submontante,impostoapl, rendmes, aplsub, poupancadv, poupmen,aplicadv, impostdv, aplpoup = CDI.main.principal(CDI.main, cap, taxcdi, sel, alIR, rent, mnths)
        self.ResWin(capital, selicpct, cdipct, cdimen, cdidia, txy, txm, alIR, taxacdi, rentpct, impostcdi, impostrent, mes, montanteapl, montpoupanca, submontante,impostoapl, rendmes, aplsub, poupancadv, poupmen,aplicadv, impostdv, aplpoup)
